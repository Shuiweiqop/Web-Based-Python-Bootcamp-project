...
function EditPostForm({ auth, post, categories }) {
                        ...
                        ">
                            <div className="relative">
                                <h1 className="text-4xl font-bold text-white mb-3 drop-shadow-2xl flex items-center gap-3">
                                    <Edit3 className="w-8 h-8 animate-pulse animate-float" />
                                    Edit Post
                                </h1>
                        ...
                        <div className="p-6">
                            ...
                            <div className="mb-6 p-4 bg-blue-500/20 border border-blue-500/30 rounded-xl backdrop-blur-sm animate-fadeIn">
                                <div className="flex items-start gap-3">
                                    <Clock className="w-5 h-5 text-blue-400 mt-0.5 animate-pulse-slow" />
                                    <div>
                                        ...
                                        <p className="text-sm text-blue-200">
                                            Your post will show as "edited" after you save changes. Make sure all information is accurate before updating.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            {/* Formatting Tips */}
                            <div className="mb-6 p-4 bg-purple-500/20 border border-purple-500/30 rounded-xl backdrop-blur-sm animate-fadeIn">
                                <h3 className="text-sm font-bold text-purple-300 mb-3 flex items-center gap-2">
                                    <Lightbulb className="w-5 h-5 animate-pulse-slow" />
                                    Quick Tips
                                </h3>
                                <ul className="text-sm text-purple-200 space-y-1.5">
                                    <li className="flex items-start gap-2">
                                        <span className="text-purple-400 mt-0.5">•</span>
                                        <span>Keep your edits clear and relevant</span>
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <span className="text-purple-400 mt-0.5">•</span>
                                        <span>Check spelling and grammar before saving</span>
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <span className="text-purple-400 mt-0.5">•</span>
                                        <span>Preserve the original context if possible</span>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="flex items-center gap-4">
                                <button
                                    ...
                                    className="
                                        ...
                                        ring-2 ring-orange-400/50 hover:ring-orange-400/70
                    ...
                    {(data.title || data.content) && (
                        ...
                        ">
                            ...
                            <div className="p-6">
                                ...
                                {/* Edit Badge Preview */}
                                <div className="mt-6 inline-flex items-center gap-2 px-3 py-1.5 bg-orange-500/20 border border-orange-500/30 rounded-lg">
                                    <Edit3 className="w-4 h-4 text-orange-400" />
                                    <span className="text-xs font-medium text-orange-300">This post will show as edited</span>
                                </div>
                            </div>
                        </div>
                    )}
