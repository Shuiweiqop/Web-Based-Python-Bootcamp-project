...
import { Head, useForm, Link } from '@inertiajs/react'; // 添加 Link
        ...
        <AuthenticatedLayout 
            ...
            header={
                <div className="flex justify-between items-center">
                    <div>
                        <h2 className="text-3xl font-bold">Edit Assignment Settings</h2>
                        <p className="mt-2 text-sm opacity-90">
                            Modify the learning path assignment for {assignment.student.name}
                        </p>
                    </div>
                    {/* 可选：在这个页面，我们可以放一个返回按钮在右上角 */}
                    <Link
        ...
        >
            ...
            <div className="py-12">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    {/* ❌ 2. 已移除原来的 Header div (div className="mb-8") */}
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6 space-y-6">
                        ...
                        <div className="flex items-center justify-between pt-4 border-t">
                            ...
                            <div className="flex gap-3">
                                {/* 移除了 View Details，因为 Cancel 就是返回 */}
                                <button
