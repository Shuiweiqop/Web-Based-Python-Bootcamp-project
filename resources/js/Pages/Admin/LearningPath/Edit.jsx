...
export default function Edit({ auth, path, difficultyOptions }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        min_score_required: path.min_score_required || 0,
        max_score_required: path.max_score_required || 100,
        icon: path.icon || 'book',
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('admin.learning-paths.update', path.path_id));
    };
                ...
                <div className="max-w-4xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="mb-6">
                        ...
                        <p className="mt-1 text-sm text-gray-600">
                            Update the details of "{path.title}"
                        </p>
                    </div>
