...
export default function Create({ auth, test, typeOptions, difficultyOptions, statusOptions }) {
    ...
    // Update correct_answer placeholder based on type
    useEffect(() => {
        if (data.type === 'mcq') {
    ...
    const handleSubmit = (e) => {
        ...
        post(route('admin.placement-tests.questions.store', test.test_id));
    };
    ...
    return (
        <AuthenticatedLayout user={auth.user}>
            <Head title={`Create Question - ${test.title}`} />
                    ...
                    <div className="mb-6 flex items-center justify-between">
                        <div>
                            ...
                            <p className="mt-1 text-sm text-gray-600">
                                Add a question to: <span className="font-semibold">{test.title}</span>
                            </p>
                        </div>
                    </div>
